...
const doughnutColors = ['#6366f1', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#06b6d4', '#ec4899', '#14b8a6'];

export default function TrendChart({ labels, datasets, title, type = 'line', height = 300 }: TrendChartProps) {
  const chartData = {
    labels,
    datasets: datasets.map((ds, i) => {
      ...
      return {
        ...
        backgroundColor: ds.fill !== false ? (ds.color ? `${ds.color}20` : palette.bg) : 'transparent',
        fill: ds.fill !== false,
        tension: 0.4,
        borderWidth: 2,
        pointRadius: 0,
